...
import {
  Sparkles, ArrowRight, ShieldCheck, Trees, Sliders,
  ChevronDown, X, Compass, MapPin, MessageSquare, PhoneCall
} from "lucide-react";
...
export default function App() {
  ...
  const [activeMaterial, setActiveMaterial] = useState<MaterialSample | null>(null);
    ...
    <div className="min-h-screen bg-[#121212] flex flex-col font-sans text-white antialiased selection:bg-[#ff8562] selection:text-white relative">
      ...
      {toast && (
        <div className="fixed top-24 left-1/2 -translate-x-1/2 z-50 w-full max-w-md px-4 pointer-events-none">
          <div className={`pointer-events-auto p-4 rounded-xs border shadow-lg flex items-start gap-3 transition-all duration-300 ${
            toast.type === "success" ? "bg-[#181818] border-[#ff8562] text-white" : "bg-[#1c1c1c] border-zinc-700 text-white/95"
          }`} style={{ boxShadow: toast.type === "success" ? "rgba(255, 133, 98, 0.2) 0px 10px 30px" : "rgba(0,0,0,0.5) 0px 10px 25px" }}>
            ...
            <button onClick={() => setToast(null)} className="text-white/40 hover:text-white shrink-0 focus:outline-none">
      ...
      {currentPage === "home" && (
        <>
          ...
          <section className="relative w-full min-h-[90vh] flex flex-col justify-center items-center overflow-hidden border-b border-white/10 py-20">
            <div className="absolute inset-0 z-0">
              <img src="https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?auto=format&fit=crop&q=80&w=2000"
                alt="Luxury Minimal Living Room Background" referrerPolicy="no-referrer"
                className="w-full h-full object-cover opacity-35 filter brightness-50" />
              <div className="absolute inset-0 bg-gradient-to-t from-[#121212] via-neutral-950/20 to-[#121212]/90" />
              <div className="absolute inset-0 bg-gradient-to-r from-[#121212]/40 via-transparent to-[#121212]/40" />
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#ff8562] opacity-[0.04] rounded-full filter blur-3xl pointer-events-none" />
            </div>
            <div className="max-w-5xl mx-auto px-4 z-10 text-center space-y-8 flex flex-col items-center">
              <div className="inline-flex items-center gap-2 px-3 py-1 sm:py-1.5 border border-white/15 bg-black/60 rounded-full text-[9px] sm:text-[10px] tracking-wider sm:tracking-[0.2em] uppercase text-white/80 font-mono max-w-[95%]">
                <span className="w-1.5 h-1.5 rounded-full bg-[#ff8562] shrink-0 animate-pulse" />
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 pt-4 w-full justify-center">
                <button onClick={() => handleScrollToSection("catalog")}
                ...
                <button onClick={() => handleScrollToSection("benefits")}
              ...
              <div className="pt-12 cursor-pointer flex flex-col items-center gap-1.5 text-white/30 hover:text-[#ff8562] transition-colors"
                onClick={() => handleScrollToSection("benefits-strip")}>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8 divide-y md:divide-y-0 md:divide-x divide-white/10">
                <div className="flex items-start gap-4 pt-8 md:pt-0">
                  ...
                  <div>
                    <h4 className="text-base font-semibold text-white tracking-wide">Индивидуально или по шаблону</h4>
                ...
                <div className="flex items-start gap-4 pt-8 md:pt-0 md:pl-8">
                  ...
                  <div>
                    <h4 className="text-base font-semibold text-white tracking-wide">Официальная гарантия 10 лет</h4>
                    <p className="text-white/50 text-xs font-sans mt-1.5 leading-relaxed">
                ...
                <div className="flex items-start gap-4 pt-8 md:pt-0 md:pl-8">
                  ...
                  <div>
                    <h4 className="text-base font-semibold text-white tracking-wide">Прочность и плотность дерева</h4>
                    <p className="text-white/50 text-xs font-sans mt-1.5 leading-relaxed">
          ...
          {/* CATALOG */}
          <CatalogGrid onNotify={triggerNotification} onOpenInquiry={handleOpenGeneralInquiry} products={products} />
          ...
          <section className="py-20 bg-[#161616] border-y border-white/5 relative overflow-hidden text-center flex flex-col items-center justify-center">
            ...
            <div className="max-w-3xl mx-auto px-4 space-y-5 relative z-10">
              ...
              <div className="pt-4 flex justify-center">
                <button onClick={() => { setCurrentPage("builder"); setTimeout(() => window.scrollTo({ top: 0, behavior: "smooth" }), 50); }}
          ...
          <section id="materials" className="py-24 bg-[#181818] border-y border-white/10">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="mb-16">
                <p className="text-[#ff8562] font-mono text-xs uppercase tracking-[0.25em] mb-3">Тактильный слой дизайна</p>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                <div className="lg:col-span-5 space-y-3">
                  {(materials || []).map(sample => (
                    <button key={sample.id} onClick={() => setActiveMaterial(sample)}
                      className={`w-full p-4 border text-left rounded-lg transition-all flex items-center gap-4 focus:outline-none cursor-pointer ${
                        activeMaterial?.id === sample.id ? "border-[#ff8562] bg-[#ff8562]/5" : "border-white/5 bg-black/20 hover:border-white/10"
                      }`}>
                      <div className="w-12 h-12 rounded-md overflow-hidden bg-zinc-800 border border-white/10 shrink-0">
                        <img src={sample.image} alt={sample.name} referrerPolicy="no-referrer" className="w-full h-full object-cover" />
                      </div>
                      ...
                      {activeMaterial?.id === sample.id && <div className="w-2 h-2 rounded-full bg-[#ff8562]" />}
                    </button>
                  ))}
                </div>
                  ...
                  {activeMaterial && (
                    <>
                      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-start">
                        <div className="md:col-span-5">
                          <div className="aspect-square w-full rounded-md overflow-hidden border border-white/10">
                            <img src={activeMaterial.image} alt={activeMaterial.name} referrerPolicy="no-referrer" className="w-full h-full object-cover" />
                          </div>
                        </div>
                        <div className="md:col-span-7 flex flex-col justify-between h-full">
                          <div>
                            ...
                            <h4 className="text-xl font-serif text-white mt-3 mb-2">{activeMaterial.name}</h4>
                            <p className="text-white/70 text-xs font-sans leading-relaxed mb-4">{activeMaterial.description}</p>
                          </div>
                      ...
                      <div className="border-t border-white/10 pt-5 mt-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        ...
                        <button onClick={() => handleOpenGeneralInquiry(`Образец: ${activeMaterial.name}`)}
          ...
          {/* EXCURSION BOOKING */}
          <ExcursionBooking onNotify={triggerNotification} />

          {/* PHILOSOPHY / PHOTOS */}
          <section className="py-24 bg-[#121212] relative overflow-hidden">
            <div className="absolute inset-0 pointer-events-none opacity-[0.05] bg-[radial-gradient(#ffffff_1.2px,transparent_1.2px)] [background-size:24px_24px]" />
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                <div className="lg:col-span-6 space-y-6">
                  <span className="text-[#ff8562] font-mono text-xs uppercase tracking-[0.25em] block">Стандарты ручной подгонки</span>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="border border-white/5 bg-[#181818] p-4 rounded-xs">
                      ...
                      <span className="text-xs text-white/90 font-sans block mt-1">Официальный юридический гарантийный срок</span>
                    </div>
                  </div>
                  <div className="pt-4">
                    <button onClick={() => handleOpenGeneralInquiry("Консультация с главным инженером")}
                ...
                <div className="lg:col-span-6 grid grid-cols-2 gap-4">
                  <div className="space-y-4">
                    {[
                      { src: "https://images.unsplash.com/photo-1541123437800-1bb1317badc2?auto=format&fit=crop&q=80&w=400", label: "Окрасочный сектор", aspect: "aspect-square" },
                      { src: "https://images.unsplash.com/photo-1504148455328-c376907d081c?auto=format&fit=crop&q=80&w=400", label: "Полировка латуни", aspect: "aspect-video" },
                    ].map((img, i) => (
                      <div key={i} className={`${img.aspect} overflow-hidden bg-zinc-900 border border-white/15 rounded-md relative group`}>
                        <img src={img.src} alt={img.label} referrerPolicy="no-referrer"
                          className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
                        <div className="absolute inset-0 bg-black/40" />
                        <span className="absolute bottom-3 left-3 text-[10px] font-mono text-white/80">{img.label}</span>
                      </div>
                    ))}
                  </div>
                  <div className="space-y-4 pt-8">
                    {[
                      { src: "https://images.unsplash.com/photo-1513694203232-719a280e022f?auto=format&fit=crop&q=80&w=400", label: "Склад слэбов", aspect: "aspect-video" },
                      { src: "https://images.unsplash.com/photo-1581428982868-e410dd047a90?auto=format&fit=crop&q=80&w=400", label: "Сборка столешниц", aspect: "aspect-square" },
                    ].map((img, i) => (
                      <div key={i} className={`${img.aspect} overflow-hidden bg-zinc-900 border border-white/15 rounded-md relative group`}>
                        <img src={img.src} alt={img.label} referrerPolicy="no-referrer"
                          className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
          ...
          <section id="faq" className="py-24 bg-[#181818] border-t border-white/10">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-16">
                <p className="text-[#ff8562] font-mono text-xs uppercase tracking-[0.25em] mb-3">Информационный блок</p>
                ...
                {FAQS.map((faq, index) => {
                  ...
                  return (
                    <div key={index} className="transition-colors duration-300">
                      <button onClick={() => setExpandedFaqIndex(isOpen ? null : index)}
                        ...
                        <span className="text-sm font-semibold tracking-wide font-serif pr-4 leading-relaxed">{faq.question}</span>
                        <span className={`text-base font-bold transition-transform duration-300 shrink-0 ${isOpen ? "rotate-180 text-[#ff8562]" : "text-white/40"}`}>▼</span>
                      </button>
                      {isOpen && (
                        <div className="p-5 border-t border-white/5 bg-white/[0.01]">
                          <p className="text-xs text-white/60 font-sans leading-relaxed whitespace-pre-line">{faq.answer}</p>
                        </div>
                      )}
                    </div>
                  );
          ...
          <section className="py-24 bg-[#121212] flex flex-col items-center justify-center text-center wood-grain-overlay border-t border-white/10">
            <div className="max-w-3xl mx-auto px-4 space-y-6">
              <span className="text-xs text-[#ff8562] tracking-[0.25em] font-mono uppercase">НАЧНИТЕ СВОЙ ПРОЕКТ С НАМИ</span>
              ...
              <div className="pt-4">
                <button onClick={() => handleOpenGeneralInquiry("Общий выезд на замер")}
      ...
      {currentPage === "builder" && (
        <InteractiveBuilder onNotify={triggerNotification} />
      )}

      {currentPage === "contacts" && (
        <ContactsPage onNotify={triggerNotification} />
      )}
      ...
      <div className="fixed bottom-6 right-6 z-40 flex flex-col gap-2.5">
        <button onClick={() => handleOpenGeneralInquiry("Быстрый обратный звонок")}
        ...
        <a href="#telegram-external-link" onClick={e => { e.preventDefault(); triggerNotification("Чат-поддержка Telegram запущена! (Имитация)", "success"); }}
      ...
      {/* FOOTER */}
      <Footer onScrollToSection={handleScrollToSection} onNavigate={setCurrentPage} />
    </div>
  );
}
